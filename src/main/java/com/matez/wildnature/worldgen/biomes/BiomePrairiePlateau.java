...
public class BiomePrairiePlateau extends Biome {

    protected static final WorldGenAbstractTree TREE = new WorldGenBigTree(true);

    public BiomePrairiePlateau() {
        super(new BiomeProperties("Prairie Plateau").setBaseBiome("prairie").setBaseHeight(2F).setHeightVariation(0.1F).setTemperature(0.50F).setRainfall(0.4F));
