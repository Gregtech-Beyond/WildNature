...
public class BiomeDeciduousForest extends Biome {
    ...
    public static IBlockState APPLELOG = ModBlocks.APPLE_LOG.getDefaultState();
    public static IBlockState APPLELEAVES = ModBlocks.APPLE_LEAVES.getDefaultState();
    public static IBlockState PEARLOG = ModBlocks.PEAR_LOG.getDefaultState();
    public static IBlockState PEARLEAVES = ModBlocks.PEAR_LEAVES.getDefaultState();
    ...
    public BiomeDeciduousForest() {
        super(new BiomeProperties("Deciduous Forest").setBaseHeight(0.1F).setHeightVariation(0.05F).setTemperature(0.40F).setRainfall(0.4F));
    ...
    public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
        ...
        //
        TREE12= new treeGen_rowan(true);
        TREE13= new treeGen_miniTree(true,APPLELOG,APPLELEAVES);
        TREE14= new treeGen_miniTree(true,PEARLOG,PEARLEAVES);
        //
        TREE15= new treeGen_beech(true);

        switch(Main.generateRandomInt(0,11,rand)){
