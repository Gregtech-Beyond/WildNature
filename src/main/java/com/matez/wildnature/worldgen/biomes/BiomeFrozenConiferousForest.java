...
public class BiomeFrozenConiferousForest extends Biome {

    public static IBlockState LOG1 = Blocks.PACKED_ICE.getDefaultState();
    public static IBlockState LOG2 = Blocks.PACKED_ICE.getDefaultState();
    public static IBlockState LOG3 = Blocks.PACKED_ICE.getDefaultState();

    public static IBlockState LEAVES1 = Blocks.ICE.getDefaultState();
    public static IBlockState LEAVES2 = Blocks.ICE.getDefaultState();
    public static IBlockState LEAVES3 = Blocks.ICE.getDefaultState();
    ...
    public BiomeFrozenConiferousForest() {
        super(new BiomeProperties("Frozen Coniferous Forest").setBaseHeight(0.2F).setHeightVariation(0.1F).setTemperature(0.0F).setRainfall(0.3F).setSnowEnabled());
    ...
    public void addDefaultFlowers() {
        ...
        this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityWolf.class, 3, 3, 5));
