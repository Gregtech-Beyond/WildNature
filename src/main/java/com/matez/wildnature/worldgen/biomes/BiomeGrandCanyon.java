...
public class BiomeGrandCanyon extends Biome {
    ...
    public BiomeGrandCanyon() {
        super(new BiomeProperties("Grand Canyon").setBaseBiome("mesa").setBaseHeight(2F).setHeightVariation(2.5F).setTemperature(0.85F).setRainfall(0.2F));
