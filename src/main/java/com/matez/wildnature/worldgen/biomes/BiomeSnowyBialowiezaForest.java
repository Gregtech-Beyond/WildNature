...
public class BiomeSnowyBialowiezaForest extends Biome {
    ...
    public BiomeSnowyBialowiezaForest() {
        super(new BiomeProperties("Snowy Bialowieza Forest").setBaseHeight(0.1F).setHeightVariation(0.025F).setTemperature(0.10F).setRainfall(0.6F).setSnowEnabled());
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal) {
        int a = Main.generateRandomInt(0,12,rand);
        if(a==0){
