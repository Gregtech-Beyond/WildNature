...
public class BiomeDenseDarkForest extends Biome {
    ...
    public BiomeDenseDarkForest() {
        super(new BiomeProperties("Dark Dense Forest").setBaseBiome("forest").setBaseHeight(0.25F).setHeightVariation(0.15F).setTemperature(0.40F).setRainfall(0.6F));
