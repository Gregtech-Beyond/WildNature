...
public class BiomeSandyTropics extends Biome {
    ...
    public BiomeSandyTropics() {
        super(new BiomeProperties("Sandy Tropics").setBaseBiome("desert").setBaseHeight(0.1F).setHeightVariation(0.2F).setTemperature(0.90F).setRainfall(0.6F).setWaterColor(0xF9FFB1));
