...
public class BiomeRedSavannaDesertHills extends Biome {

    protected static final WorldGenAbstractTree TREE = new WorldGenSavannaTree(true);


    public BiomeRedSavannaDesertHills() {
        super(new BiomeProperties("Red Savanna Desert Hills").setBaseBiome("savanna").setBaseHeight(0.6F).setHeightVariation(0.2F).setTemperature(0.85F).setRainfall(0.2F));
