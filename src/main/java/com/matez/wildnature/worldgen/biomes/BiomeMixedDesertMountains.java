...
public class BiomeMixedDesertMountains extends Biome {

    protected static final WorldGenAbstractTree TREE = new WorldGenSavannaTree(true);


    public BiomeMixedDesertMountains() {
        super(new BiomeProperties("Mixed Desert Mountains").setBaseBiome("desert").setBaseHeight(0.6F).setHeightVariation(0.59F).setTemperature(0.85F).setRainfall(0.2F));
