...
public class BiomeSavannaDesertHills extends Biome {

    protected static final WorldGenAbstractTree TREE = new WorldGenSavannaTree(true);


    public BiomeSavannaDesertHills() {
        super(new BiomeProperties("Savanna Desert").setBaseBiome("savanna").setBaseHeight(0.6F).setHeightVariation(0.2F).setTemperature(0.85F).setRainfall(0.2F));
