...
public class BiomePineHill extends Biome {
    ...
    public BiomePineHill() {
        super(new BiomeProperties("Pine Hill").setBaseBiome("pine_forest").setBaseHeight(1.4F).setHeightVariation(0.2F).setTemperature(0.20F).setRainfall(0.3F));
