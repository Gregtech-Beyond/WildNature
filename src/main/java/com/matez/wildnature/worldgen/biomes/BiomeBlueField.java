...
public class BiomeBlueField extends Biome {
    ...
    public BiomeBlueField() {
        super(new BiomeProperties("Blue Valley").setBaseBiome("plains").setBaseHeight(0.2F).setHeightVariation(0.13F).setTemperature(0.40F).setRainfall(0.4F));
    ...
    public WorldGenerator getRandomWorldGenForGrass(Random rand) {
        return new WorldGenGrass(ModBlocks.IRIS_VIOLET.getDefaultState().withProperty(FloweringTallGrass.FLOWERING,true));
    }
    ...
    public BiomeDecorator createBiomeDecorator() {
        ...
        decorator.grass.add(ModBlocks.IRIS_VIOLET.getDefaultState().withProperty(FloweringTallGrass.FLOWERING,true));
        decorator.grass.add(ModBlocks.FORGET_ME_NOT_BLUE.getDefaultState().withProperty(FloweringTallGrass.FLOWERING,true));
        ...
        decorator.flowers.add(ModBlocks.IRIS_PURPLE.getDefaultState(),15);
