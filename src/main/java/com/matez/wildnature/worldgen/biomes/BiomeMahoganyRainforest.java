...
public class BiomeMahoganyRainforest extends Biome {
    ...
    public BiomeMahoganyRainforest() {
        super(new BiomeProperties("Mahogany Rainforest").setBaseBiome("jungle").setBaseHeight(0.06F).setHeightVariation(0.01F).setTemperature(0.90F).setRainfall(0.8F));
