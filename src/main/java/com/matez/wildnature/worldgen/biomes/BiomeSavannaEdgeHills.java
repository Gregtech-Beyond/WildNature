...
public class BiomeSavannaEdgeHills extends Biome {

    protected static final WorldGenAbstractTree TREE = new WorldGenSavannaTree(true);


    public BiomeSavannaEdgeHills() {
        super(new BiomeProperties("Savanna Desert Edge Hills").setBaseBiome("savanna").setBaseHeight(0.3F).setHeightVariation(0.25F).setTemperature(0.85F).setRainfall(0.2F));
