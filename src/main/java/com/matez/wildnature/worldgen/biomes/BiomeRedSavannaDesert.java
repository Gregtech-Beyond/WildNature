...
public class BiomeRedSavannaDesert extends Biome {

    protected static final WorldGenAbstractTree TREE = new WorldGenSavannaTree(true);


    public BiomeRedSavannaDesert() {
        super(new BiomeProperties("Red Savanna Desert").setBaseBiome("savanna").setBaseHeight(0.1F).setHeightVariation(0.03F).setTemperature(0.85F).setRainfall(0.2F));
