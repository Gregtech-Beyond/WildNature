...
public class BiomeConiferousForest extends Biome {
    ...
    public BiomeConiferousForest() {
        super(new BiomeProperties("Coniferous Forest").setBaseHeight(0.2F).setHeightVariation(0.1F).setTemperature(0.25F).setRainfall(0.3F));
    ...
    public void addDefaultFlowers() {
        ...
        this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityBoar.class, 6, 1, 3));
        this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityWolf.class, 4, 3, 5));
