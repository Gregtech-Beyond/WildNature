...
public class treeGen_fir2 extends WorldGenSchematicTree
{


    public treeGen_fir2(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
