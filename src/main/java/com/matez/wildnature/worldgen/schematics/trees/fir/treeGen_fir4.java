...
public class treeGen_fir4 extends WorldGenSchematicTree
{


    public treeGen_fir4(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
