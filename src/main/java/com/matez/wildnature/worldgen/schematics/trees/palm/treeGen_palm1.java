...
public class treeGen_palm1 extends WorldGenSchematicTree
{


    public treeGen_palm1(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
