...
public class treeGen_palm2 extends WorldGenSchematicTree
{


    public treeGen_palm2(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
