...
public class treeGen_fir8 extends WorldGenSchematicTree
{


    public treeGen_fir8(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
