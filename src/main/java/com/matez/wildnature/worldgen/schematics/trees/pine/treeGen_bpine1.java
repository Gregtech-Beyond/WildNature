...
public class treeGen_bpine1 extends WorldGenSchematicTree
{


    public treeGen_bpine1(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
