...
public class treeGen_birch8 extends WorldGenSchematicTree
{


    public treeGen_birch8(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
