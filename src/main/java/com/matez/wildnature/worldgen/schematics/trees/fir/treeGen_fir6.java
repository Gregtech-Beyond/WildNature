...
public class treeGen_fir6 extends WorldGenSchematicTree
{


    public treeGen_fir6(boolean parShouldNotify, @Nullable IBlockState logState, @Nullable IBlockState leavesState) {
