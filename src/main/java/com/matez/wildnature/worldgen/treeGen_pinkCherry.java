...
public class treeGen_pinkCherry extends WorldGenAbstractTree
{
    private Random rand;
    private World world;
    ...
    List<treeGen_pinkCherry.FoliageCoordinates> foliageCoords;

    public treeGen_pinkCherry(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<treeGen_pinkCherry.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new treeGen_pinkCherry.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new treeGen_pinkCherry.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (treeGen_pinkCherry.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(state, this.world, down, net.minecraft.util.EnumFacing.UP, ((net.minecraft.block.BlockBush) ModBlocks.CHERRY_PINK_SAPLING));
