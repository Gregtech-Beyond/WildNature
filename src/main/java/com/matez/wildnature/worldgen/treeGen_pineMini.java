...
public class treeGen_pineMini extends WorldGenAbstractTree
{
     ...
     */
    public treeGen_pineMini(boolean parShouldNotify)
    {
    ...
    {
        int minHeight = Main.generateRandomInt(-1,3) + minTreeHeight;
