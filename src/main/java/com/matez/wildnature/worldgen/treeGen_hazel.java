...
public class treeGen_hazel extends WorldGenAbstractTree
{
    private Random rand;
    private World world;
    ...
    List<treeGen_hazel.FoliageCoordinates> foliageCoords;

    public treeGen_hazel(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<treeGen_hazel.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new treeGen_hazel.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new treeGen_hazel.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), ModBlocks.HAZEL_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (treeGen_hazel.FoliageCoordinates treeGen_hazel$foliagecoordinates : this.foliageCoords)
        {
    ...
    void generateTrunk()
    {
        ...
        Block block = ModBlocks.HAZEL_LOG;
    ...
    void generateLeafNodeBases()
    {
        for (treeGen_hazel.FoliageCoordinates treeGen_hazel$foliagecoordinates : this.foliageCoords)
        {
            ...
            {
                this.limb(blockpos, treeGen_hazel$foliagecoordinates, ModBlocks.HAZEL_LOG);
            }
        }
    }
