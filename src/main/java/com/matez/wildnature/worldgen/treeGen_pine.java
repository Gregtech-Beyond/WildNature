...
public class treeGen_pine extends WorldGenAbstractTree
{
     ...
     */
    public treeGen_pine(boolean parShouldNotify)
    {
    ...
    {
        int minHeight = Main.generateRandomInt(-3,7) + minTreeHeight;
