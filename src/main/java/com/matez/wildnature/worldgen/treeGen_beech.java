...
public class treeGen_beech extends WorldGenAbstractTree
{
    private IBlockState blockStateWood = ModBlocks.BEECH_LOG.getDefaultState();
     ...
     */
    public treeGen_beech(boolean parShouldNotify)
    {
