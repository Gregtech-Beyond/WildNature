...
import com.matez.wildnature.util.IStructure;
...
public class WorldGenStructure extends WorldGenerator implements IStructure {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        return this.generateStructure(worldIn,position);
    }

    public static boolean generateStructure(World world, BlockPos pos){
