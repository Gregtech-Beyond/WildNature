package com.matez.wildnature.worldgen.generators.Chunk;
...
public class ChunkGeneratorWildNature2 implements IChunkGenerator
{
    protected static final IBlockState STONE = Blocks.STONE.getDefaultState();
    protected static IBlockState ROCK;
    ...
    public ChunkGeneratorWildNature2(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
        ...
        this.mainPerlinNoise = new NoiseGeneratorOctaves(this.rand, 1);
        this.surfaceNoise = new NoiseGeneratorPerlin(this.rand, 4);
        this.scaleNoise = new NoiseGeneratorOctaves(this.rand, 24);
        ...
        this.minLimitPerlinNoise = (NoiseGeneratorOctaves)ctx.getLPerlin1();
        this.maxLimitPerlinNoise = (NoiseGeneratorOctaves)ctx.getLPerlin2();
        this.mainPerlinNoise = (NoiseGeneratorOctaves)ctx.getPerlin();
        this.surfaceNoise = (NoiseGeneratorPerlin)ctx.getHeight();
        this.scaleNoise = (NoiseGeneratorOctaves)ctx.getScale();
        this.depthNoise = (NoiseGeneratorOctaves)ctx.getDepth();
        this.forestNoise = (NoiseGeneratorOctaves)ctx.getForest();
    }
