...
import com.matez.wildnature.worldgen.generators.WoodlandMansionGen;
import com.matez.wildnature.worldgen.generators.cave.MapGenCaves;
import com.matez.wildnature.worldgen.generators.cave.MapGenRavine;
...
public class ChunkGeneratorWildNature implements IChunkGenerator
{
    ...
    private WoodlandMansionGen woodlandMansionGenerator = new WoodlandMansionGen(this);
    ...
    public ChunkGeneratorWildNature(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
            ...
            woodlandMansionGenerator = (WoodlandMansionGen)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(woodlandMansionGenerator, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.WOODLAND_MANSION);
        }
        this.world = worldIn;
