...
public class treeGen_bigJacaranda extends WorldGenAbstractTree
{
    private Random rand;
    private World world;
    ...
    List<treeGen_bigJacaranda.FoliageCoordinates> foliageCoords;

    public treeGen_bigJacaranda(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<treeGen_bigJacaranda.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new treeGen_bigJacaranda.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new treeGen_bigJacaranda.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), ModBlocks.JACARANDA_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (treeGen_bigJacaranda.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
    ...
    void generateTrunk()
    {
        ...
        Block block = ModBlocks.JACARANDA_LOG;
    ...
    void generateLeafNodeBases()
    {
        for (treeGen_bigJacaranda.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
            ...
            {
                this.limb(blockpos, worldgenbigtree$foliagecoordinates, ModBlocks.JACARANDA_LOG);
            }
        }
    }
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(state, this.world, down, net.minecraft.util.EnumFacing.UP, ((net.minecraft.block.BlockBush) ModBlocks.JACARANDA_SAPLING));
