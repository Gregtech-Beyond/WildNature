...
public class treeGen_eucalyptus extends WorldGenAbstractTree
{
    private Random rand;
    private World world;
    ...
    List<treeGen_eucalyptus.FoliageCoordinates> foliageCoords;
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<treeGen_eucalyptus.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new treeGen_eucalyptus.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new treeGen_eucalyptus.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (treeGen_eucalyptus.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(state, this.world, down, net.minecraft.util.EnumFacing.UP, ((net.minecraft.block.BlockBush) ModBlocks.EUCALYPTUS_SAPLING));
