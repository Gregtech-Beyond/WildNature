...
public class treeGen_rowan extends WorldGenAbstractTree
{

    Block LOG = ModBlocks.ROWAN_LOG;
    Block LEAVES = ModBlocks.ROWAN_LEAVES;
    private Random rand;
    private World world;
    ...
    List<treeGen_rowan.FoliageCoordinates> foliageCoords;

    public treeGen_rowan(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<treeGen_rowan.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new treeGen_rowan.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new treeGen_rowan.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (treeGen_rowan.FoliageCoordinates treeGen_hazel$foliagecoordinates : this.foliageCoords)
        {
