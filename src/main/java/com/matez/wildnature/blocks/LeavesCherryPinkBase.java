...
public class LeavesCherryPinkBase extends WNBlockLeaves implements IHasModel {
    ...
    NBTTagCompound tag;
    public LeavesCherryPinkBase(String name, Material material){
        super();
    ...
    public void normalFruitGen(World worldIn,BlockPos pos){
        if(!worldIn.isAirBlock(pos)) {
            ...
            if (gen == 0) {
                worldIn.setBlockState(pos, ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(VARIANT, 1));
            } else if (gen == 1) {
                if (worldIn.getBlockState(pos) == worldIn.getBlockState(pos).withProperty(VARIANT, 0)) {
                    worldIn.setBlockState(pos, ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(VARIANT, 1));
                } else {
                    worldIn.setBlockState(pos, ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(VARIANT, 2));
                }
            } else if (gen == 2) {
                if (worldIn.getBlockState(pos) == worldIn.getBlockState(pos).withProperty(VARIANT, 0)) {

                } else {
                    worldIn.setBlockState(pos, ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(VARIANT, 3));
                }
            } else if (gen == 3) {
                if (worldIn.getBlockState(pos) == worldIn.getBlockState(pos).withProperty(VARIANT, 0)) {

                } else {
                    worldIn.setBlockState(pos, ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(VARIANT, 4));
                }
            } else {
                ...
                if (gen == 0) {
                    if (BlockVariant != 0) {
                        if (BlockVariant == 1) {
                            worldIn.setBlockState(pos, ModBlocks.CHERRY_PINK_LEAVES.getDefaultState().withProperty(VARIANT, 0));
