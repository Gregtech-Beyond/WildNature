...
public class LeavesJacarandaBase extends WNBlockLeaves implements IHasModel {
    ...
    NBTTagCompound tag;
    public LeavesJacarandaBase(String name, Material material) {
        super();
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return getDefaultState().withProperty(VARIANT,(meta &1)).withProperty(DECAYABLE, Boolean.valueOf((meta & 4) == 0)).withProperty(CHECK_DECAY, Boolean.valueOf((meta & 8) > 0));
    }
    ...
    public void normalFruitGen(World worldIn,BlockPos pos){
        ...
        if (gen == 0 || gen==1 || gen==2) {
            worldIn.setBlockState(pos, ModBlocks.JACARANDA_LEAVES.getDefaultState().withProperty(VARIANT, 1));
        } else if (gen == 3) {
            worldIn.setBlockState(pos, ModBlocks.JACARANDA_LEAVES.getDefaultState().withProperty(VARIANT, 0));
        }
    }
    ...
    public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
        ...
        if(BlockVariant!=0){
            worldIn.setBlockState(pos, ModBlocks.JACARANDA_LEAVES.getDefaultState().withProperty(VARIANT,0));
            spawnAsEntity(worldIn, pos, new ItemStack(ModBlocks.JACARANDA_KWIAT));
        }
