 ...
 */
public class ModelWisentMale extends ModelBase {
    ...
    public ModelWisentMale() {
        ...
        this.RightHorn.setRotationPoint(-1.5F, -2.5F, -7.5F);
        ...
        this.Body4.setRotationPoint(1.0F, -4.1F, 0.0F);
        ...
        this.Body2.addBox(0.0F, 0.0F, 0.0F, 10, 12, 12, 0.0F);
        ...
        this.Body3.setRotationPoint(-0.4F, -0.3F, 11.7F);
        ...
        this.setRotateAngle(Body5, -0.3364036803121388F, 0.0F, 0.0F);
        ...
        this.LeftHorn.setRotationPoint(6.9F, 0.0F, -7.5F);
