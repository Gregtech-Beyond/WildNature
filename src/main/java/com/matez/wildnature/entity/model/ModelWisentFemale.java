 ...
 */
public class ModelWisentFemale extends ModelBase {
    ...
    public ModelWisentFemale() {
        this.textureWidth = 128;
        this.textureHeight = 128;
        this.Body4 = new ModelRenderer(this, 51, 77);
        this.Body4.setRotationPoint(1.0F, -2.6F, 0.0F);
        ...
        this.Head1.setRotationPoint(-0.5F, -5.1F, -2.4F);
        ...
        this.Neck.setRotationPoint(0.0F, 5.1F, -5.4F);
        ...
        this.setRotateAngle(Body5, -0.18015742672619053F, 0.0F, 0.0F);
        this.udders = new ModelRenderer(this, 86, 33);
        this.udders.setRotationPoint(3.5F, 12.0F, -1.0F);
        this.udders.addBox(0.0F, 0.0F, 0.0F, 4, 2, 6, 0.0F);
        this.Neck2 = new ModelRenderer(this, 86, 65);
        this.Neck2.setRotationPoint(-2.5F, -4.4F, -4.7F);
        ...
        this.LeftHorn.setRotationPoint(6.9F, 1.0F, -5.8F);
        this.LeftHorn.addBox(-3.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
        this.setRotateAngle(LeftHorn, 0.7853981633974483F, -0.0F, 0.7845254987714512F);
        ...
        this.setRotateAngle(RightHorn, 0.7853981633974483F, 0.0F, -0.6453079928861649F);
        this.Body3 = new ModelRenderer(this, 50, 44);
        this.Body3.setRotationPoint(-0.5F, -0.3F, 12.4F);
