 ...
 */
public class ModelWisentBaby extends ModelBase {
    ...
    public ModelWisentBaby() {
        ...
        this.Body3.setRotationPoint(1.5F, -2.0F, 3.0F);
        this.Body3.addBox(0.0F, 0.0F, 0.0F, 5, 3, 11, 0.0F);
        this.setRotateAngle(Body3, -0.19928937535533275F, 0.0F, 0.0F);
        this.BackLeftLeg = new ModelRenderer(this, 0, 51);
        this.BackLeftLeg.setRotationPoint(6.25F, 7.5F, 13.9F);
        ...
        this.Body2.setRotationPoint(1.0F, -2.4F, 0.0F);
        ...
        this.BackRightLeg.setRotationPoint(1.75F, 7.5F, 13.9F);
