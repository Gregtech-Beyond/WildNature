...
public class ModelForester extends ModelBiped
{
    ...
    public ModelForester(float modelSize, boolean smallArmsIn)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if(entityIn.getEntityWorld().getBiome(entityIn.getPosition()).getTemperature(entityIn.getPosition())<=0.25F || entityIn.getEntityWorld().getBiome(entityIn.getPosition()).isSnowyBiome()){
            isCold=true;
            setWearables(true);
        }else{
            isCold=false;
    ...
    public void setWearables(boolean visible){
        this.bipedLeftArmwear.showModel = visible;
        this.bipedRightArmwear.showModel = visible;
        this.bipedLeftLegwear.showModel = visible;
        this.bipedRightLegwear.showModel = visible;
