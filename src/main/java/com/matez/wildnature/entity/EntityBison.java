...
{
    private static final DataParameter<Integer> BOOST_TIME = EntityDataManager.<Integer>createKey(EntityBison.class, DataSerializers.VARINT);
    ...
    protected void mateAI(){
        this.tasks.addTask(2, new EntityAIAdvancedMate(this,EntityBisonMale.class,EntityBisonFemale.class, 0.6D,EntityBisonChild.class));
        this.tasks.addTask(3, new EntityAIAdvancedFollowParent(this,EntityBisonFemale.class, 0.4D));
    }
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.ATTACK_SPEED).setBaseValue(2.0D);
    ...
    {
        this.playSound(SoundEvents.ENTITY_COW_STEP, 0.4F, 0.6F);
    }
    ...
    {
        return LootTableHandler.BISON_LOOT;
    }
    ...
    public EntityBison createChild(EntityAgeable ageable)
    {
        ...
        EntityBisonChild child = new EntityBisonChild(this.world);
        child.setType(2);
        return child;
    }
    ...
    {
        if(otherAnimal instanceof EntityBison){
            if(((EntityBison)otherAnimal).getType()!=this.getType() && ((EntityBison)otherAnimal).getType() != 2 && this.getType()!=2){
